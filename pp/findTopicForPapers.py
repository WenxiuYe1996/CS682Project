...
# -------------------------------------------------------------------------------------------------------
# -------------------------------------------------------------------------------------------------------
def findTopicForPapers(userInputTopic, lang="en"):
    ...
    # # #----------------------------------------------------------------------------------------------------   
    weighted_paper_with_topic = getListWithWeightedKeyWord(paper_with_topic)
    ...
    new_list_html = f'table/{topic}similar_article.html'
