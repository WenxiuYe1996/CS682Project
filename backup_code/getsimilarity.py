...
# Main method
# -----------------------------------------------------------------------------------------------------
def getsimilarity(userInputArticle1, userInputArticle2):
    
    # # Download the link
    # # # #----------------------------------------------------------------------------------------------------
    # # Read the links from the csv file
    text_list = []
    text_list.append(getText(userInputArticle1))
    text_list.append(getText(userInputArticle2))
    ...
    print(similarity)
    similarity_list = []
    similarity_list.append(f'Similarity: {similarity}')

    return similarity_list


print(getsimilarity('https://ntrs.nasa.gov/api/citations/20120003419/downloads/20120003419.pdf', 
    'https://ntrs.nasa.gov/api/citations/20120003419/downloads/20120003419.pdf'))

print(getsimilarity('https://ntrs.nasa.gov/api/citations/20120003419/downloads/20120003419.pdf', 
    'https://ntrs.nasa.gov/api/citations/20130013996/downloads/20130013996.pdf'))
