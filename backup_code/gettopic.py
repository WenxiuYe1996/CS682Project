...
# Main method
# -----------------------------------------------------------------------------------------------------
def gettopic(userInputArticle):
    
    # # Download the link
    # # # #----------------------------------------------------------------------------------------------------
    # # Read the links from the csv file
    
    text = getText(userInputArticle)
    
    name = userInputArticle.split('/')
...
gettopic('https://ntrs.nasa.gov/api/citations/20210023715/downloads/NASA-TM-20210023715.pdf')
